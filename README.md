...
대표 과정인 `React 웹사이트 만들기`는 10주·30회차 웹 교안으로 제공됩니다. 각 회차에는 준비물, 50분 수업 진행표, 강사용 쉬운 설명, 실습, 예제 코드, Codex 요청문, 정답이 포함된 확인 문제, 오류 복구 순서, 과제와 완료 기준이 있습니다. 강의 화면의 `이 회차 교안 인쇄·PDF 저장` 버튼을 누르면 브라우저 인쇄 기능으로 종이 교안이나 PDF 파일로 저장할 수 있습니다.
