...
const webFoundationPilot = {
  ...
  ...Object.fromEntries([
    ['04', 'HTML 문서의 head와 body를 구분하고 문자 인코딩·화면 너비·탭 제목 정보를 작성합니다.', ['head에는 보이지 않는 문서 정보, body에는 화면 내용을 작성했습니다.', '한글과 모바일 화면에 필요한 meta 태그가 있습니다.']],
    ['05', 'header·main·section·footer를 사용해 내용의 역할이 드러나는 문서 구조를 만듭니다.', ['제목과 소개는 header, 핵심 학습 내용은 main에 있습니다.', 'footer에 연습용 문의 정보가 구분되어 있습니다.']],
    ['06', '예제의 서비스명·대상·결과를 자신의 주제로 바꾸고 문서 정보를 함께 완성합니다.', ['탭 제목과 화면 제목이 자신의 주제로 변경됐습니다.', '대상과 4주 완성 결과가 구체적으로 작성됐습니다.']],
    ['07', 'h1부터 h3까지 제목 단계를 건너뛰지 않고 정보의 상하 관계를 표현합니다.', ['페이지 핵심 제목은 h1 한 개입니다.', '과정과 세부 수업이 h2·h3으로 구분됩니다.']],
    ['08', '문단으로 설명을 묶고 목적지가 분명한 링크로 같은 페이지의 과정 영역에 이동합니다.', ['교육 설명이 완전한 문장으로 표시됩니다.', '링크를 누르면 curriculum 영역으로 이동합니다.']],
    ['09', '자신의 교육 주제로 제목·설명·행동 링크를 작성해 한 화면의 정보 흐름을 완성합니다.', ['교육 대상과 결과를 첫 화면에서 이해할 수 있습니다.', '행동 링크 문구가 이동 결과를 정확히 설명합니다.']],
    ['10', '의미 있는 대체 설명을 가진 이미지와 준비물 목록을 사용해 반복 정보를 구조화합니다.', ['이미지가 표시되지 않아도 대체 설명으로 의미를 알 수 있습니다.', '준비물 세 개가 ul과 li 목록으로 표시됩니다.']],
    ['11', 'figure·img·figcaption과 ul을 연결해 이미지 의미와 준비물을 한 묶음으로 표현합니다.', ['이미지 설명과 준비물 목록이 구분됩니다.', '대체 설명이 이미지 장면의 의미를 전달합니다.']],
    ['12', '이미지와 준비 순서를 자신의 수업 주제로 바꾸고 순서가 중요한 정보에는 ol을 사용합니다.', ['나의 수업에 맞는 이미지 설명이 작성됐습니다.', '준비 과정이 순서 목록으로 표시됩니다.']],
    ['13', 'CSS가 HTML 요소를 선택해 모양만 바꾸며 문서 구조는 유지됨을 확인합니다.', ['body와 card에 서로 다른 스타일이 적용됩니다.', 'HTML 내용 수정 없이 배경·여백·모서리가 변경됩니다.']],
    ['14', '태그 선택자와 클래스 선택자의 범위를 구분해 카드 내부 요소에만 스타일을 적용합니다.', ['lesson-card 요소만 카드 모양입니다.', '카드 안의 제목과 문단에 다른 규칙이 적용됩니다.']],
    ['15', '색상·그림자·버튼 규칙을 자신의 서비스 카드에 적용합니다.', ['나의 서비스 제목과 설명이 표시됩니다.', '링크가 버튼처럼 보이고 키보드로 선택됩니다.']],
    ['16', '본문과 제목의 색상·크기·줄 간격을 구분해 읽기 편한 정보 흐름을 만듭니다.', ['제목과 본문의 크기·색상이 구분됩니다.', '본문에 충분한 줄 간격이 있습니다.']],
    ['17', 'padding은 안쪽, margin은 바깥 간격임을 두 카드의 실제 배치로 비교합니다.', ['카드 내용이 가장자리에 붙지 않습니다.', '두 카드 사이에 바깥 간격이 있습니다.']],
    ['18', '글자·색상·여백 규칙을 대표 영역에 통합해 자신의 서비스에 맞게 조정합니다.', ['제목·설명·행동 버튼의 순서가 분명합니다.', '배경과 글자의 대비가 충분합니다.']],
    ['19', 'Flex의 정렬과 gap으로 메뉴 링크를 한 줄에 일정하게 배치합니다.', ['메뉴가 한 줄 중앙에 정렬됩니다.', '링크 간격이 gap으로 적용됩니다.']],
    ['20', 'Flex로 대표 영역의 텍스트와 이미지를 나란히 놓고 모바일에서는 세로로 바꿉니다.', ['PC에서는 텍스트와 이미지가 두 열입니다.', '680px 이하에서는 한 열이며 이미지가 넘치지 않습니다.']],
    ['21', 'Grid로 프로그램 카드 세 개를 같은 너비로 배치하고 모바일에서는 한 열로 전환합니다.', ['PC에서 카드가 세 열로 정렬됩니다.', '680px 이하에서 한 열이며 가로 스크롤이 없습니다.']],
    ['22', '변수에 과정명과 기간을 저장하고 DOM 요소의 문구를 JavaScript로 변경합니다.', ['과정명과 기간이 변수 값으로 표시됩니다.', 'HTML을 직접 고치지 않고 JavaScript가 문구를 바꿉니다.']],
    ['23', '이름을 입력받아 환영 문장을 반환하는 함수로 반복 동작을 한 곳에 묶습니다.', ['함수에 이름을 전달하면 완성된 문장이 반환됩니다.', '반환값이 화면 문단에 표시됩니다.']],
    ['24', '배열의 교육 단계를 map으로 li 문자열로 바꾸고 하나의 목록으로 출력합니다.', ['배열 세 항목이 번호가 있는 화면 목록으로 표시됩니다.', '배열 값을 바꾸면 화면 목록도 함께 변경됩니다.']],
    ['25', '버튼 클릭 이벤트로 안내 문구를 바꾸고 중복 클릭을 막는 상태를 표시합니다.', ['버튼을 누른 뒤 안내 문장이 변경됩니다.', '처리 완료 후 버튼이 비활성화됩니다.']],
    ['26', 'input 이벤트로 현재 입력값을 읽고 aria-live 안내 문구에 즉시 반영합니다.', ['입력할 때 이름이 안내 문장에 표시됩니다.', '입력을 지우면 다시 입력 안내가 나타납니다.']],
    ['27', '폼 제출을 막고 이름의 공백과 필수값을 검사해 성공 또는 오류를 안내합니다.', ['빈 이름은 제출되지 않고 오류가 표시됩니다.', '이름이 있으면 체험 확인 문구가 표시됩니다.']],
    ['28', '미디어 쿼리로 세 열 카드가 680px 이하에서 한 열이 되도록 구성합니다.', ['PC에서는 세 열, 모바일에서는 한 열입니다.', '390px 화면에서 내용이 잘리거나 넘치지 않습니다.']],
    ['29', '모바일·링크·폼·대체 설명을 점검하고 npm build 결과를 배포 전 기록합니다.', ['네 가지 점검 결과가 문서에 기록됩니다.', '빌드 명령과 성공 여부를 설명할 수 있습니다.']],
    ['30', 'HTML·CSS·JavaScript 결과를 하나의 반응형 교육 홈페이지로 통합하고 발표합니다.', ['메뉴·소개·프로그램·체험 폼이 한 화면에서 동작합니다.', '모바일과 폼 오류를 확인하고 완성 결과를 설명합니다.']],
  ].map(([number, guide, expected]) => [`web-foundation-${number}`, {
    instructorGuide: `${guide} 완성 파일을 먼저 보여주지 말고 시작 파일에서 태그를 하나씩 추가할 때마다 저장과 새로고침을 반복하게 합니다.`,
    practice: [`${number}회차 시작 파일을 내려받아 이전 회차 폴더와 분리해 저장합니다.`, guide, '예제의 문구나 항목 한 가지를 자신의 주제로 바꿉니다.', 'Chrome에서 정상 화면과 잘못 작성한 경우를 비교합니다.', '완성 파일과 비교한 뒤 다른 부분과 배운 점을 기록합니다.'],
    expectedResult: expected,
    errors: ['화면이 비거나 일부만 나오면 태그의 여는 부분과 닫는 부분을 위에서부터 확인합니다.', '한글이 깨지거나 모바일이 넓게 보이면 charset과 viewport meta 태그를 확인합니다.', '링크나 이미지가 동작하지 않으면 href·src의 경로와 따옴표를 확인합니다.'],
    rubric: ['3점: 회차의 핵심 HTML 구조를 정확히 작성했습니다.', '2점: 예제 내용을 자신의 주제로 수정했습니다.', '2점: 브라우저에서 정상·오류 상태를 확인했습니다.', '2점: 완성 파일과 차이를 스스로 찾았습니다.', '1점: 결과와 배운 점을 기록했습니다.'],
    downloads: [{ label: `${Number(number)}회차 시작 파일`, path: `practice/web-foundation/lesson-${number}-start.html` }, { label: `${Number(number)}회차 완성 파일`, path: `practice/web-foundation/lesson-${number}-complete.html` }],
  }]))
}

const reactPilot = Object.fromEntries([
  ['01', 'Vite 개발 서버를 실행하고 App.jsx 문구를 수정해 저장과 화면 갱신 흐름을 확인합니다.', 'jsx', ['수정한 제목과 설명이 첫 화면에 표시됩니다.', '터미널의 로컬 주소와 실행 명령을 설명할 수 있습니다.']],
  ['02', 'Header와 MainContent를 함수 컴포넌트로 나눠 JSX 화면 부품의 역할을 구분합니다.', 'jsx', ['Header와 본문이 별도 함수에서 표시됩니다.', '컴포넌트 이름·export·호출 관계가 올바릅니다.']],
  ['03', '프로그램 배열을 map으로 반복하고 ProgramCard에 객체를 전달합니다.', 'jsx', ['서로 다른 카드 세 개가 표시됩니다.', '각 반복 항목에 고유한 key가 있습니다.']],
  ['04', 'CSS Grid와 미디어 쿼리로 카드가 PC 3열, 모바일 1열이 되게 합니다.', 'css', ['PC에서 카드가 세 열로 표시됩니다.', '680px 이하에서 한 열이며 가로 스크롤이 없습니다.']],
  ['05', 'useState로 선택 분야를 기억하고 filter로 표시 목록을 계산합니다.', 'jsx', ['전체와 프런트엔드 버튼의 결과가 다릅니다.', '선택할 때 결과 개수가 함께 변경됩니다.']],
  ['06', '주소에서 받은 ID로 프로그램을 찾고 없는 ID에는 복구 링크를 제공합니다.', 'jsx', ['올바른 ID에는 상세 내용이 보입니다.', '없는 ID에는 백지 대신 안내와 목록 링크가 보입니다.']],
  ['07', '제어 입력과 submit 이벤트를 연결하고 공백 이름을 오류로 안내합니다.', 'jsx', ['빈 이름에는 오류 문장이 표시됩니다.', 'label과 오류 문장이 입력 요소에 연결됩니다.']],
  ['08', '빌드·PC·모바일·오류 주소를 순서대로 검사하고 발표 기록을 남깁니다.', 'md', ['빌드와 네 가지 점검 결과가 문서에 기록됩니다.', '완성 결과와 해결한 문제를 발표할 수 있습니다.']],
  ['09', 'components·pages·data·styles 폴더로 파일 역할을 나누고 이동 계획을 만듭니다.', 'txt', ['화면 부품·페이지·데이터·스타일 위치가 구분됩니다.', 'App.jsx에는 화면 연결 역할만 남기는 구조입니다.']],
  ['10', 'title·level·duration props를 받아 같은 카드가 서로 다른 내용을 표시하게 합니다.', 'jsx', ['카드 함수 한 개로 내용이 다른 카드 두 개가 표시됩니다.', 'props 이름과 전달 위치를 설명할 수 있습니다.']],
  ['11', 'loading·빈 목록·정상 목록을 조건에 따라 구분해 백지 화면을 방지합니다.', 'jsx', ['로딩 중에는 상태 안내가 표시됩니다.', '빈 배열과 정상 목록이 서로 다른 화면으로 표시됩니다.']],
  ['12', '검색어를 정리해 프로그램 제목과 설명을 실시간으로 검색하고 결과 수를 안내합니다.', 'jsx', ['제목과 설명의 일부 문장으로 검색됩니다.', '검색 결과 개수가 aria-live 영역에 표시됩니다.']],
  ['13', '분야와 난이도 조건을 동시에 적용하고 한 번에 초기화하는 복합 필터를 만듭니다.', 'jsx', ['두 조건을 모두 만족하는 결과만 표시됩니다.', '초기화하면 전체 조건과 결과로 돌아갑니다.']],
  ['14', '원본 배열을 복사한 뒤 이름·최신·기본 순으로 정렬합니다.', 'jsx', ['원본 프로그램 배열은 변경되지 않습니다.', '정렬 선택에 따라 목록 순서가 달라집니다.']],
  ['15', '목록을 9개씩 잘라 현재 페이지를 표시하고 첫·마지막 페이지 버튼을 제한합니다.', 'jsx', ['현재 페이지의 항목만 화면에 표시됩니다.', '첫 페이지 이전과 마지막 페이지 다음 버튼이 비활성화됩니다.']],
  ['16', '검색어·분야·페이지를 hash 주소의 query로 읽고 써서 새로고침과 공유에 유지합니다.', 'jsx', ['주소를 다시 열어도 같은 검색 조건이 복원됩니다.', '기본값은 주소에서 생략되고 필요한 조건만 기록됩니다.']],
  ['17', '찜 ID를 localStorage에 JSON으로 저장하고 손상된 값은 빈 배열로 복구합니다.', 'jsx', ['찜 상태가 버튼과 aria-pressed에 표시됩니다.', '새로고침 후에도 같은 브라우저에서 찜이 유지됩니다.']],
  ['18', '완료 ID를 저장하고 완료 수를 전체 회차로 나눠 진도율과 progress에 표시합니다.', 'jsx', ['완료와 취소가 즉시 진도율에 반영됩니다.', '전체가 0개여도 계산 오류가 발생하지 않습니다.']],
  ['19', 'TVmaze 공개 API를 fetch로 호출하고 응답 상태·JSON·요청 취소를 처리합니다.', 'jsx', ['작품 세 개의 제목과 평점이 표시됩니다.', '컴포넌트 종료 시 진행 중인 요청을 취소합니다.']],
  ['20', '비동기 화면을 로딩·오류·결과 없음·성공 네 상태로 나누고 오류 복구 버튼을 제공합니다.', 'jsx', ['각 상태에 알맞은 안내가 하나씩 표시됩니다.', '오류 화면에서 다시 시도 동작을 실행할 수 있습니다.']],
  ['21', '하나의 form 객체와 공통 변경 함수로 이름·신청 동기 입력을 관리합니다.', 'jsx', ['입력한 항목만 변경되고 다른 값은 유지됩니다.', '신청 동기 글자 수가 300자 안에서 표시됩니다.']],
  ['22', 'label·aria-invalid·aria-describedby·role을 연결해 오류를 키보드와 화면낭독기에 전달합니다.', 'jsx', ['입력 이름과 오류 문장이 프로그램상으로 연결됩니다.', '오류 유무가 aria-invalid에 반영됩니다.']],
  ['23', 'Supabase 공개 프로그램을 정렬해 조회하고 로딩·오류·성공 상태로 표시합니다.', 'jsx', ['공개 프로그램의 제목·분야·난이도가 표시됩니다.', '조회 실패 시 오류가 빈 화면 대신 표시됩니다.']],
  ['24', '브라우저 공개 환경변수와 서버 비밀정보를 구분하고 실제 값 없는 예시 파일을 만듭니다.', 'env.example', ['필요한 공개 변수 이름만 기록돼 있습니다.', '실제 키·비밀번호·service role 키가 포함되지 않습니다.']],
  ['25', '관리자 프로그램 등록 폼에 필수값 검사와 Supabase insert·오류 안내를 연결합니다.', 'jsx', ['빈 필수값은 데이터베이스 요청 전에 차단됩니다.', '등록 성공과 실패 메시지가 사용자에게 표시됩니다.']],
  ['26', '공개 조회와 관리자 등록·수정·삭제를 각각 제한하는 RLS 정책을 SQL로 작성합니다.', 'sql', ['테이블에 RLS가 활성화됩니다.', '일반 사용자의 변경은 정책에서 차단됩니다.']],
  ['27', '홈부터 관리자까지 사용자 흐름과 정상·오류 조건을 통합 테스트 표로 기록합니다.', 'md', ['주요 흐름마다 정상과 오류 조건이 있습니다.', '빌드 결과와 미완료 항목을 기록할 수 있습니다.']],
  ['28', '이미지 lazy loading·크기·대체 설명·실패 대체 이미지를 적용합니다.', 'jsx', ['이미지가 화면 근처에서 로드되고 레이아웃 크기가 예약됩니다.', '주소 실패 시 대체 이미지와 설명이 유지됩니다.']],
  ['29', 'Node.js 22에서 npm ci와 빌드를 실행하고 dist를 GitHub Pages에 배포합니다.', 'yml', ['main push 시 빌드·배포 작업이 실행됩니다.', 'Pages에 필요한 권한과 dist 경로가 설정됩니다.']],
  ['30', '프로젝트 실행·기능·테스트·보안·인수 항목을 최종 문서로 정리합니다.', 'md', ['다음 담당자가 로컬 실행과 배포 순서를 재현할 수 있습니다.', '보안 주의와 미완료 항목이 분명하게 기록됩니다.']],
].map(([number, guide, extension, expected]) => [`react-${number}`, {
  instructorGuide: `${guide} 완성 파일을 먼저 복사하지 말고 시작 파일에서 한 단계씩 수정한 뒤 브라우저 또는 터미널 결과를 확인하게 합니다.`,
  practice: [`${Number(number)}회차 시작 파일을 내려받아 해당 React 프로젝트의 알맞은 위치에 복사합니다.`, guide, '예제의 제목·값·조건 중 한 가지를 자신의 교육 주제로 수정합니다.', '브라우저 화면과 터미널 오류를 확인하고 첫 오류가 있으면 기록합니다.', '완성 파일과 비교한 뒤 변경 이유와 결과를 설명합니다.'],
  expectedResult: expected,
  errors: ['화면이 비면 터미널과 브라우저 콘솔의 첫 번째 오류, 파일 저장 여부를 확인합니다.', 'import 또는 컴포넌트 오류가 나면 파일명·경로·대소문자·export를 확인합니다.', '화면은 나오지만 동작하지 않으면 이벤트 함수와 상태 변경 위치를 확인합니다.'],
  rubric: ['3점: 회차의 핵심 React 또는 CSS 기능이 동작합니다.', '2점: 예제를 자신의 교육 주제로 수정했습니다.', '2점: 정상 화면과 오류 상태를 확인했습니다.', '2점: 완성 파일과 차이를 설명했습니다.', '1점: 결과와 배운 점을 기록했습니다.'],
  downloads: [{ label: `${Number(number)}회차 시작 파일`, path: `practice/react-website/lesson-${number}-start.${extension}` }, { label: `${Number(number)}회차 완성 파일`, path: `practice/react-website/lesson-${number}-complete.${extension}` }],
}]))

const nodePilot = Object.fromEntries([
  ['01', 'Node.js 버전과 실행 위치를 확인하고 첫 JavaScript 파일을 터미널에서 실행합니다.', ['터미널에 과정명과 실행 명령이 표시됩니다.', '브라우저 JavaScript와 Node.js 실행 위치의 차이를 설명합니다.']],
  ['02', 'node:http로 3000번 포트 서버를 열고 UTF-8 일반 문장을 응답합니다.', ['브라우저에서 한국어 응답이 표시됩니다.', '서버 종료 전까지 요청을 계속 기다립니다.']],
  ['03', '요청 방식과 주소를 기록하고 /health 성공과 나머지 404 응답을 구분합니다.', ['/health는 200과 ok JSON을 반환합니다.', '없는 주소는 404와 쉬운 오류 문장을 반환합니다.']],
  ['04', 'Express 앱의 GET / 경로와 listen을 연결해 첫 프레임워크 서버를 실행합니다.', ['루트 주소에서 EDU Express 문장이 표시됩니다.', '터미널에 실제 접속 주소가 안내됩니다.']],
  ['05', '환경 포트 기본값·health 상태·404 처리를 추가해 서버 상태를 확인합니다.', ['PORT가 없으면 3000번을 사용합니다.', 'health와 없는 주소의 상태 코드가 다릅니다.']],
  ['06', 'middleware에서 요청 시각·방식·경로를 기록하고 next로 다음 처리에 전달합니다.', ['요청할 때마다 터미널에 접근 기록이 남습니다.', 'next 호출 후 health 응답이 정상적으로 이어집니다.']],
  ['07', '교육자료 자원에 목록 GET과 등록 POST 주소를 만들고 JSON 본문을 읽습니다.', ['GET은 배열을 반환합니다.', 'POST는 201 상태와 새 자료를 반환합니다.']],
  ['08', ':id 주소 매개변수로 상세 GET·일부 수정 PATCH·삭제 DELETE를 구분합니다.', ['세 요청이 같은 자원 주소와 다른 방식으로 구분됩니다.', '삭제 성공은 204 빈 응답을 반환합니다.']],
  ['09', '동사가 들어간 옛 주소를 자원 중심 URL과 HTTP 방식으로 정리합니다.', ['목록·등록·수정·삭제 주소가 일관됩니다.', '각 요청 방식의 목적을 표로 설명합니다.']],
  ['10', '교육자료 한 건을 올바른 상태 코드와 JSON 구조로 응답하고 없는 주소를 처리합니다.', ['성공 응답에 id·제목·분야·시간이 있습니다.', '없는 주소는 404 JSON을 반환합니다.']],
  ['11', '교육자료 배열과 전체 개수를 items·total JSON 객체로 응답합니다.', ['응답에 배열과 전체 개수가 함께 있습니다.', '성공 상태 200과 JSON 형식이 사용됩니다.']],
  ['12', '객체를 JSON 문자열로 변환하고 다시 JavaScript 객체로 복원합니다.', ['직렬화된 JSON과 복원된 제목이 출력됩니다.', 'JSON 문자열과 JavaScript 객체의 차이를 설명합니다.']],
  ['13', '메모리의 교육자료 목록을 GET API에서 items와 total로 제공합니다.', ['두 교육자료가 목록 응답에 포함됩니다.', '응답 전체 개수가 실제 배열 길이와 같습니다.']],
  ['14', 'q 검색어와 category 조건을 정리해 제목·분야 필터를 동시에 적용합니다.', ['대소문자와 앞뒤 공백을 정리해 검색합니다.', '전체 분야와 특정 분야 조건이 구분됩니다.']],
  ['15', '페이지와 페이지 크기를 안전한 범위로 제한하고 현재 항목과 전체 정보를 반환합니다.', ['23개 자료의 두 번째 10개 범위가 계산됩니다.', '잘못된 페이지와 50개 초과 크기가 보정됩니다.']],
  ['16', '주소 매개변수 id로 교육자료 한 건을 찾고 없으면 404 JSON을 반환합니다.', ['올바른 ID는 해당 자료를 반환합니다.', '없는 ID는 404와 쉬운 안내를 반환합니다.']],
  ['17', '상세 조회 결과를 성공 data 또는 코드가 있는 오류 객체로 일관되게 구성합니다.', ['성공과 실패에 서로 다른 상태가 있습니다.', '오류 응답에 code와 message가 함께 있습니다.']],
  ['18', '숫자 ID의 형식을 먼저 검사하고 400 형식 오류와 404 자료 없음 오류를 구분합니다.', ['문자·0·음수 ID는 400입니다.', '형식은 맞지만 자료가 없으면 404입니다.']],
  ['19', 'JSON 요청 본문을 읽어 고유 ID·정리된 값·생성 시간을 가진 새 자료를 등록합니다.', ['등록 성공은 201과 새 자료를 반환합니다.', '요청 본문 크기가 20KB로 제한됩니다.']],
  ['20', '제목 필수·100자 제한과 분야 필수 조건을 함수에서 검사합니다.', ['빈 값에 항목별 오류가 반환됩니다.', '정상 값은 공백이 정리된 data로 반환됩니다.']],
  ['21', '입력 검증 결과를 POST API에 연결해 잘못된 값은 400, 정상 값은 201로 처리합니다.', ['빈 값은 항목별 errors와 함께 거부됩니다.', '정상 값은 고유 ID를 가진 새 자료로 등록됩니다.']],
  ['22', '허용된 제목만 수정하고 대상 없음과 잘못된 입력을 각각 404·400으로 구분합니다.', ['기존 항목의 다른 값은 유지됩니다.', '수정 시간과 변경된 제목이 결과에 포함됩니다.']],
  ['23', 'findIndex로 정확한 한 건을 찾아 삭제하고 삭제한 자료와 남은 배열을 확인합니다.', ['존재하는 ID 한 건만 삭제됩니다.', '없는 ID는 404 결과를 반환합니다.']],
  ['24', '수정·삭제 함수를 PATCH와 DELETE 주소에 연결하고 상태 코드를 적용합니다.', ['PATCH는 수정된 자료를 반환합니다.', 'DELETE 성공은 204 빈 응답입니다.']],
  ['25', '404 주소 middleware와 500 공통 오류 middleware를 마지막 순서에 배치합니다.', ['없는 주소는 ROUTE_NOT_FOUND를 반환합니다.', '내부 오류 상세는 숨기고 쉬운 500 문장을 반환합니다.']],
  ['26', '요청 ID·시각·방식·경로·상태·소요 시간을 기록하고 비밀번호는 로그에서 제외합니다.', ['요청마다 고유 requestId가 생성됩니다.', '응답 종료 후 상태와 처리 시간이 기록됩니다.']],
  ['27', 'JSON 본문을 20KB로 제한하고 IP별 1분 30회 간단 요청 제한을 적용합니다.', ['과도한 요청은 429로 거부됩니다.', '허용 범위 요청은 다음 처리로 진행됩니다.']],
  ['28', 'Node 내장 fetch와 assert로 목록 API의 200·items 배열·total을 자동 검사합니다.', ['정상 서버에서 세 검사가 모두 통과합니다.', '응답 구조가 바뀌면 assert가 실패 원인을 표시합니다.']],
  ['29', '빈 제목 등록과 존재하지 않는 상세 ID를 요청해 400·404 오류를 자동 검사합니다.', ['입력 오류는 400으로 확인됩니다.', '없는 자료는 404로 확인됩니다.']],
  ['30', '모든 API의 방식·주소·성공·오류 상태를 인수 가능한 명세 배열로 정리합니다.', ['CRUD 다섯 주소가 표로 출력됩니다.', '입력·없음·크기·요청 제한 오류가 문서화됩니다.']],
].map(([number, guide, expected]) => [`node-backend-${number}`, {
  instructorGuide: `${guide} 코드를 실행하기 전에 어떤 주소와 상태가 나올지 먼저 말하게 하고, 실행 후 브라우저와 터미널 결과를 함께 비교합니다.`,
  practice: [`${Number(number)}회차 시작 파일을 별도 Node.js 연습 폴더에 저장합니다.`, guide, '완성 파일을 보기 전에 주석 위치의 코드를 직접 작성합니다.', '정상 주소와 잘못된 주소를 각각 요청하고 상태와 응답을 기록합니다.', '완성 파일과 비교해 요청·처리·응답 흐름을 설명합니다.'],
  expectedResult: expected,
  errors: ['실행이 안 되면 node -v, 현재 폴더와 파일명을 확인합니다.', 'express 모듈 오류가 나면 연습 폴더에서 npm init -y와 npm install express를 실행했는지 확인합니다.', '주소가 열리지 않으면 포트 번호·서버 실행 상태·첫 번째 터미널 오류를 확인합니다.'],
  rubric: ['3점: 회차의 서버 또는 요청 기능이 정상 동작합니다.', '2점: 상태 코드와 JSON 응답을 확인했습니다.', '2점: 정상·오류 주소를 모두 시험했습니다.', '2점: 완성 파일과 차이를 설명했습니다.', '1점: 실행 명령과 결과를 기록했습니다.'],
  downloads: [{ label: `${Number(number)}회차 시작 파일`, path: `practice/node-backend/lesson-${number}-start.js` }, { label: `${Number(number)}회차 완성 파일`, path: `practice/node-backend/lesson-${number}-complete.js` }],
}]))

const supabasePilot = Object.fromEntries([
  ['01', '테이블·행·열을 교육자료 표에 비유하고 데이터베이스가 공동 자료를 저장하는 역할을 확인합니다.', ['테이블·행·열의 차이를 설명합니다.', 'SQL Editor에서 첫 조회 결과를 확인합니다.']],
  ['02', 'VALUES로 만든 임시 교육자료 세 건에서 필요한 id와 title 열을 순서대로 조회합니다.', ['세 행이 id 순으로 표시됩니다.', '한 행이 교육자료 한 건임을 확인합니다.']],
  ['03', '프로그램과 교육자료를 별도 표로 나눠 반복 제목 대신 ID로 연결하는 구조를 설계합니다.', ['부모·자식 테이블과 연결 열이 구분됩니다.', '중복을 줄이는 이유를 설명합니다.']],
  ['04', '자동 증가 기본키와 필수 제목을 가진 연습용 교육자료 테이블을 생성합니다.', ['practice_lessons 테이블이 생성됩니다.', 'id는 자동 번호이고 title은 필수입니다.']],
  ['05', 'text·integer·boolean·timestamptz 자료형과 기본값·check 조건을 적용합니다.', ['분야·시간·공개·생성일 열이 추가됩니다.', '학습시간은 0보다 큰 값만 허용됩니다.']],
  ['06', '정상 교육자료를 등록하고 returning으로 생성된 번호와 시간을 확인합니다.', ['정상 자료가 등록되고 생성값이 반환됩니다.', '0분 자료는 제약조건 때문에 거부됩니다.']],
  ['07', 'UUID 기본키와 고유 제목을 가진 프로그램 테이블을 생성합니다.', ['프로그램 ID가 UUID로 자동 생성됩니다.', '같은 프로그램 제목은 중복 등록되지 않습니다.']],
  ['08', '교육자료에 program_id 외래키와 조회용 인덱스를 추가하고 부모 삭제 규칙을 정합니다.', ['program_id가 프로그램 ID만 참조합니다.', '프로그램 삭제 시 연결 자료가 함께 정리됩니다.']],
  ['09', 'WITH와 returning을 사용해 새 프로그램 ID를 받아 연결 교육자료를 등록합니다.', ['프로그램과 교육자료가 한 흐름에서 등록됩니다.', '교육자료의 program_id가 실제 프로그램을 가리킵니다.']],
  ['10', '필요한 열만 선택해 최근 생성 순으로 최대 10개 조회합니다.', ['select 결과에 필요한 여섯 열만 보입니다.', '최신 자료가 위에 표시되고 최대 10개입니다.']],
  ['11', 'where에 공개 여부와 최소 학습 시간 조건을 함께 적용하고 최신순으로 조회합니다.', ['공개된 30분 이상 자료만 표시됩니다.', '결과가 최신 생성 순서로 정렬됩니다.']],
  ['12', 'ilike와 % 검색 기호로 제목에 React가 포함된 자료를 대소문자 구분 없이 찾습니다.', ['React가 포함된 제목만 표시됩니다.', '검색어 앞뒤에 다른 글자가 있어도 검색됩니다.']],
  ['13', 'group by와 집계 함수로 분야별 자료 수와 평균 학습 시간을 계산합니다.', ['분야마다 한 행이 표시됩니다.', '자료 수와 평균 시간이 계산됩니다.']],
  ['14', 'left join으로 프로그램과 연결 교육자료를 한 결과표에서 확인합니다.', ['프로그램명과 자료명이 함께 표시됩니다.', '자료가 없는 프로그램도 결과에 남습니다.']],
  ['15', 'update와 returning으로 정확한 한 행의 학습 시간을 수정하고 결과를 즉시 확인합니다.', ['대상 한 건만 60분으로 변경됩니다.', '변경된 id·제목·시간이 반환됩니다.']],
  ['16', '삭제 대상을 먼저 확인하고 트랜잭션과 rollback으로 안전하게 삭제를 연습합니다.', ['삭제된 한 행이 returning으로 표시됩니다.', 'rollback 후 원래 자료가 유지됩니다.']],
  ['17', '제목 고유 조건을 기준으로 등록과 수정을 한 문장으로 처리하는 upsert를 연습합니다.', ['처음에는 프로그램이 등록됩니다.', '다시 실행해도 중복 행이 생기지 않습니다.']],
  ['18', '공개 자료만 담은 security_invoker 뷰를 만들어 React 조회용 데이터 모양을 단순화합니다.', ['공개 자료에 필요한 열만 조회됩니다.', '뷰가 원본 테이블의 RLS 권한을 따릅니다.']],
  ['19', 'Auth 사용자 ID와 연결되는 프로필 테이블을 만들고 본인만 조회하는 첫 RLS 정책을 적용합니다.', ['practice_profiles에 RLS가 활성화됩니다.', '로그인 사용자는 자신의 프로필만 조회합니다.']],
  ['20', '교육자료 공개 조회와 로그인 사용자 등록을 서로 다른 RLS 정책으로 구분합니다.', ['비로그인 사용자는 공개 자료만 조회합니다.', '로그인 사용자만 새 자료 등록 요청이 허용됩니다.']],
  ['21', 'Auth 사용자 ID와 관리자 여부를 연결하는 관리자 권한 테이블을 만들고 RLS를 활성화합니다.', ['관리자 권한이 사용자 UUID와 연결됩니다.', '브라우저에서 임의로 권한을 추가할 수 없습니다.']],
  ['22', '고정 search_path와 제한된 실행 권한을 가진 관리자 확인 함수를 작성합니다.', ['로그인 관리자는 true를 반환합니다.', '함수 실행 권한이 authenticated 역할로 제한됩니다.']],
  ['23', '기존 로그인 사용자 등록 정책을 관리자 전용 INSERT 정책으로 교체합니다.', ['관리자만 교육자료를 등록할 수 있습니다.', '일반 로그인 사용자의 등록은 RLS가 차단합니다.']],
  ['24', 'USING과 WITH CHECK를 함께 사용해 관리자만 수정하도록 제한합니다.', ['관리자만 기존 행을 수정할 수 있습니다.', '수정된 행도 관리자 조건을 통과해야 합니다.']],
  ['25', 'DELETE 정책을 추가해 관리자만 교육자료를 삭제하도록 구성합니다.', ['관리자 삭제 요청은 허용됩니다.', '일반 사용자와 비로그인 삭제는 차단됩니다.']],
  ['26', 'updated_at 열과 BEFORE UPDATE 트리거로 변경 시간을 자동 기록합니다.', ['자료 수정 시 updated_at이 바뀝니다.', '등록 시각과 수정 시각을 구분할 수 있습니다.']],
  ['27', '행 변경 작업·사용자·대상·시각을 보관하는 감사 로그 테이블을 만들고 관리자 조회만 허용합니다.', ['감사 로그 테이블에 RLS가 적용됩니다.', '관리자만 변경 기록을 조회합니다.']],
  ['28', 'INSERT·UPDATE·DELETE 뒤에 감사 기록을 남기는 트리거 함수를 연결합니다.', ['자료 변경 후 감사 로그가 한 건 생깁니다.', '작업 종류와 대상 ID가 기록됩니다.']],
  ['29', '트랜잭션과 충돌 처리를 사용해 여러 번 실행해도 중복되지 않는 초기 자료 SQL을 만듭니다.', ['프로그램과 연결 자료가 등록됩니다.', '다시 실행해도 같은 자료가 늘어나지 않습니다.']],
  ['30', '테이블 RLS 상태·정책 목록·자료 수를 조회하고 Dashboard CSV 백업 절차로 최종 인수 점검합니다.', ['모든 practice_ 공개 테이블의 RLS 상태를 확인합니다.', '정책과 자료 수를 기록하고 필요한 표를 백업합니다.']],
].map(([number, guide, expected]) => [`supabase-database-${number}`, {
  instructorGuide: `${guide} SQL을 실행하기 전에 영향을 받는 테이블과 예상 행 수를 먼저 말하게 하고, 결과와 오류 문장을 함께 기록합니다.`,
  practice: [`${Number(number)}회차 시작 SQL을 내려받아 Supabase SQL Editor의 새 쿼리에 붙여 넣습니다.`, guide, '연습용 practice_ 접두사 테이블만 대상으로 SQL을 실행합니다.', '결과 표 또는 성공 메시지와 첫 오류를 확인합니다.', '완성 SQL과 비교하고 테이블·열·행 변화를 기록합니다.'],
  expectedResult: expected,
  errors: ['relation does not exist가 나오면 이전 회차의 practice_ 테이블 생성 여부를 확인합니다.', 'column already exists가 나오면 같은 SQL을 이미 실행했는지 테이블 구조를 확인합니다.', '실제 edu_ 운영 테이블이 아니라 practice_ 연습 테이블인지 실행 전에 다시 확인합니다.'],
  rubric: ['3점: 회차 SQL이 연습 테이블에서 정상 실행됩니다.', '2점: 실행 전후 테이블 또는 행 변화를 확인했습니다.', '2점: 키·자료형·제약조건의 역할을 설명했습니다.', '2점: 완성 SQL과 차이를 찾았습니다.', '1점: 결과와 오류를 기록했습니다.'],
  downloads: [{ label: `${Number(number)}회차 시작 SQL`, path: `practice/supabase-database/lesson-${number}-start.sql` }, { label: `${Number(number)}회차 완성 SQL`, path: `practice/supabase-database/lesson-${number}-complete.sql` }],
}]))

export const representativeCourses = representativeCourseSpecs.map((spec) => {
  const course = makeRepresentativeCourse(spec)
  return { ...course, sessions: course.sessions.map((item) => ({ ...item, ...(webFoundationPilot[item.id] || {}), ...(nodePilot[item.id] || {}), ...(supabasePilot[item.id] || {}) })) }
})
